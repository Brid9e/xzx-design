...
- Import shared utilities from @xzx-design/utils (#18048 by @makedopamine)
...
- xzx-design Support last 2 versions of browsers (#15313 by @kooriookami)
...
- Cannot find type definition file for `xzx-design/global` (#13698 by @mioxs)
...
- xzx-design exposing ElSubMenu component (#11100 by @tolking)
...
- xzx-design dts entry (#8842 by @holazz)
...
- xzx-design fix type error (#8982 by @holazz)
...
- Deps update dependency @xzx-design/icons-vue to v2 (#7976 by @renovate[bot])
...
[v2.2.0 release note](https://github.com/xzx-design/xzx-design/discussions/7578)

#### Breaking changes

##### Button

- `type="text"` has been removed from `button`, now you can do this, for more detail see [Documentation](https://xzx-design.org/en-US/component/button.html#text-button)
...
- Deps update dependency @xzx-design/icons-vue to v1 (#6319 by @renovate[bot])
...
- Please refer to: [1.3.0-beta.1 Breaking change](https://github.com/xzx-design/xzx-design/discussions/5037)
...
- Upgrade @xzx-design/icons-vue to currentColor (#4671 by @YunYouJun)
...
- Docs replace @xzx-design/icons with @xzx-design/icons-vue (#4704 by @pdsuwwz)
...
- Please refer to: [1.2.0-beta.1 Breaking change](https://github.com/xzx-design/xzx-design/discussions/4060)
...
- Dev play add @xzx-design/icons (#4034 by @xiaoxian521)
...
- Please refer to: [Breaking changes made in 1.1.0-beta.1](https://github.com/xzx-design/xzx-design/discussions/3020)
