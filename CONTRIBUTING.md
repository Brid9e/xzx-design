...
- Issues should be opened via [Issue Template](https://elementui.github.io/issue-generator/#/en-US?repo=xzx-design), fill in the form to provide
...
- Issues that with feature request should to go to [RFCs](https://github.com/xzx-design/rfcs/issues). This helps us managing the project.
...
```shell
# If you would like to modify the website source code of https://xzx-design.org
...
You can follow the [LOCAL DEVELOPMENT GUIDE](https://xzx-design.org/en-US/guide/dev-guide.html) to do development more quickly.
...
We have a [commit template](https://xzx-design.org/en-US/guide/commit-examples.html)
